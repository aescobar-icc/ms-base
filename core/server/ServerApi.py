...
from core.mail.UtilMail import UtilMail
from core.response.ResponseApi import ResponseApi
from core.service.UtilService import UtilService
...
class ServerApi:
    ...
    def init(useDB=True):
        ...
        connx_app = connexion.App(__name__, specification_dir='/app-run',server='gevent')
        ...
        #ServerApi.registerService(app)
        #ServerApi.publishSysApi(app)
    ...
    def before_request(request):
        pass
    #     if ServerApi.useDB :
    #         DBConnection.initDB(ServerApi.app)
